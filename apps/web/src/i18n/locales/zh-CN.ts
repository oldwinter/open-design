...
export const zhCN: Dict = {
  ...
  "chat.runError.inactivityTimeoutMessage": "智能体长时间没有新输出，已因超时而中断。通常重试即可继续。",
  ...
  "modelCapability.standard": "标准",
  "modelCapability.advanced": "高级",
  "modelCapability.bestQuality": "最佳质量",
  "modelCapability.standardDescription": "为常规任务提供稳定的输出质量。",
  "modelCapability.advancedDescription": "为要求更高的任务提供更强的输出质量。",
  "modelCapability.bestQualityDescription": "为要求最高的工作提供最佳输出质量。",
