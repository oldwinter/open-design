...
export const zhTW: Dict = {
  ...
  'settings.azureBaseUrlHint': '可在 Azure portal → 你的資源 → Endpoint 中找到。',
  ...
  'homeHero.footer.speakerNotes': '備註',
  'homeHero.footer.noSpeakerNotes': '無備忘稿',
  'homeHero.footer.availableCount': '{n} 個可用',
  'homeHero.footer.noMatches': '無匹配結果',
  ...
  'chat.designToolbox.tooltip': '設計百寶箱',
  'chat.designToolbox.aria': '開啟設計百寶箱',
  'chat.designToolbox.searchPlaceholder': '搜尋 skills / MCP / plugins / connectors / design files…',
  ...
  'chat.designToolbox.action.motion.title': '加入動畫 / 動效',
  'chat.designToolbox.action.motion.badge': '動畫',
  'chat.designToolbox.action.motion.description': '為目前 HTML 或頁面元素加入進場、捲動、狀態切換和微互動。',
  'chat.designToolbox.action.motion-polish.title': '動效潤色',
  'chat.designToolbox.action.motion-polish.badge': '節奏',
  'chat.designToolbox.action.motion-polish.description': '檢查現有動效的節奏、緩動、效能和 reduced-motion 備援。',
  'chat.designToolbox.action.anti-ai-polish.title': '反 AI 味美化',
  'chat.designToolbox.action.anti-ai-polish.badge': '去味',
  'chat.designToolbox.action.anti-ai-polish.description': '移除模板感、AI 紫藍漸層、廉價卡片堆疊和空泛 copy。',
  'chat.designToolbox.action.visual-polish.title': '設計潤色 / 可交付',
  'chat.designToolbox.action.visual-polish.badge': '潤色',
  'chat.designToolbox.action.visual-polish.description': '檢查一次視覺層級、排版、間距、響應式、可訪問性和交付狀態。',
  'chat.designToolbox.action.image-gen.title': '生圖 / 視覺參考',
  'chat.designToolbox.action.image-gen.badge': '生圖',
  'chat.designToolbox.action.image-gen.description': '為目前頁面生成分區視覺參考、素材、圖示、社群圖或 moodboard。',
  'chat.designToolbox.action.video-gen.title': '生影片 / 動畫腳本',
  'chat.designToolbox.action.video-gen.badge': '影片',
  'chat.designToolbox.action.video-gen.description': '把設計轉成短影片、Remotion / Hyperframes 分鏡或可生成影片的 prompt。',
  ...
  'chat.designToolbox.context.sideChat': '側邊對話',
  'chat.designToolbox.context.liveArtifact': '即時看板',
  'chat.designToolbox.context.file': '文件',
  'chat.designToolbox.prompt.contextGeneric': '目前目標：目前開啟的 HTML / 設計檔案 / 網頁元素。',
  'chat.designToolbox.prompt.contextSpecific': '目前目標：{kind} · {label}。',
  'chat.designToolbox.prompt.preserveDraft': '保留我輸入框裡已有的意圖：{draft}',
  'chat.designToolbox.prompt.selectedSkill': '已選 skill：{skill}。請把它作為本輪主要工作流。',
  'chat.designToolbox.prompt.noSkill': '如果沒有匹配到具體 skill，請先從目前可用 skills / MCP / plugins / connectors / design files 中選擇最合適的組合。',
  'chat.designToolbox.prompt.autoMatchIntro': '請作為 Creative Director 總調度完成一套設計流程：',
  'chat.designToolbox.prompt.autoMatchStep1': '1. 先幫我定義「什麼是好看的設計」：受眾、業務目標、品牌氣質、風格參考、資訊密度、色彩/字體/動效/素材標準，以及不能出現的 AI 味/模板感。',
  'chat.designToolbox.prompt.autoMatchStep2': '2. 搜尋並匹配上面的全量資源索引，不要只看設計百寶箱推薦項；需要時組合 skills、MCP、plugins、connectors 和 design files。',
  'chat.designToolbox.prompt.autoMatchStep3': '3. 如果目標或審美標準還不夠清楚，用有限選項或表單式 UI 引導我選擇，並給出推薦預設項；如果已經足夠清楚，直接執行下一步。',
  'chat.designToolbox.prompt.autoMatchStep4': '4. 按「診斷 -> 風格方向 -> 資源選擇 -> 具體改動/生成 -> 驗證」的順序走完全程。每一步說明為什麼選這些資源，以及下一步需要我確認什麼。',
  'chat.designToolbox.prompt.motion': '請基於目前 HTML / 頁面元素加入高品質動效：進場、捲動、狀態切換或微互動任選最有效的 1-2 處。保持克制，優先 transform / opacity，並加 prefers-reduced-motion 備援。',
  'chat.designToolbox.prompt.motionPolish': '請審查並潤色現有動效的節奏、緩動、效能和可訪問性。修掉突兀、廉價或影響閱讀的動畫；必要時改成更細膩的時間線。',
  'chat.designToolbox.prompt.antiAiPolish': '請做一次反 AI 味美化：移除模板化布局、廉價漸層/光暈、無意義卡片堆疊和空泛文案；保持資訊不丟失，直接改到更像真實設計師交付。',
  'chat.designToolbox.prompt.visualPolish': '請把這個設計打磨到可交付：檢查視覺層級、排版、間距、響應式、按鈕狀態、空/載入/錯誤狀態和可訪問性，並直接完成最重要的修正。',
  'chat.designToolbox.prompt.imageGen': '請為目前設計生成下一步視覺資產方案：可以是分區參考圖、hero 素材、插畫、icon、社群圖或 moodboard。先判斷最缺哪類圖，再給可執行的生成 prompt / 文件計畫。',
  'chat.designToolbox.prompt.videoGen': '請把目前設計轉成影片方向：生成短影片分鏡、Hyperframes / Remotion 幀結構或 Sora/fal 可用 prompt。優先讓現有 HTML / 頁面內容自然變成鏡頭。',
  'chat.designToolbox.prompt.useSkill': '使用 {skill} 處理目前設計。',
  'chat.designToolbox.prompt.skillInstruction': '請先判斷最合適的加工目標，再直接完成一輪具體改動；如果它依賴外部素材或 API，請給出可執行的替代方案或明確需要我補充什麼。',
  'chat.designToolbox.prompt.selectedResource': '已選資源：{kind} · {title}（{id}）。',
  'chat.designToolbox.prompt.resourceDescription': '資源說明：{description}',
  'chat.designToolbox.prompt.pluginResource': '請把這個 plugin 當作目前設計流程的主要上下文。如果它暴露輸入項或 GenUI，請在需要時引導我選擇；如果不適合目前目標，請改選更合適的全域資源並說明原因。',
  'chat.designToolbox.prompt.mcpResource': '請優先使用這個 MCP 能力完成目前設計下一步。需要外部素材、網頁截圖、圖像/影片生成或資料時，先判斷它能否完成，再給出可執行計畫。',
  'chat.designToolbox.prompt.mcpTemplateResource': '這個 MCP 是可配置範本。如果它是完成目前設計最需要的工具，請先引導我完成配置；如果已有替代資源可用，請先用替代資源繼續。',
  'chat.designToolbox.prompt.connectorResource': '請在需要真實資料、素材、帳號內容或外部工作流時使用這個 connector；使用前先說明會讀取/寫入什麼，必要時讓我確認。',
  'chat.designToolbox.prompt.fileResource': '請把這個 design file 作為目前設計對象或參考資產，基於它完成下一步加工；如果需要同時比較其他文件，請從全量 design files 中繼續搜尋。',
  'chat.designToolbox.prompt.resourceIndex': '全域資源索引：skills({skills})、plugins({plugins})、MCP({mcpEnabled} enabled / {mcpTemplates} templates)、connectors({connectors} connected)、design files({files})。',
  'chat.designToolbox.prompt.searchableSkills': '可搜尋 skills',
  'chat.designToolbox.prompt.searchablePlugins': '可搜尋 plugins',
  'chat.designToolbox.prompt.availableMcp': '可用 MCP',
  'chat.designToolbox.prompt.connectedConnectors': '已連接 connectors',
  'chat.designToolbox.prompt.referenceDesignFiles': '可參考 design files',
  'chat.designToolbox.prompt.mcpTemplateName': '{name} 範本',
  'chat.designToolbox.prompt.processRule': '流程規則：先定義審美目標和約束，再搜尋/匹配資源；需要使用者選擇時生成有限選項 UI，引導確認後繼續執行。',
  ...
  'updater.payloadReadyGeneric': '新的 Open Design 更新已就緒。Open Design 會關閉並自動重新啟動。',
  'updater.payloadReadyVersion': 'Open Design {version} 已就緒。Open Design 會關閉並自動重新啟動。',
