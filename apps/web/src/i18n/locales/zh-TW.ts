...
export const zhTW: Dict = {
  ...
  "chat.runError.inactivityTimeoutMessage": "智慧體長時間沒有新輸出，已因逾時而中斷。通常重試即可繼續。",
  "chat.runError.emptyOutputMessage": "智慧體本次結束時沒有產生任何輸出。這通常是暫時的，重試即可再次執行。",
  "chat.runError.sessionExpiredMessage": "要恢復的工作階段已過期，已為你重置。重試即可開始一次全新執行。",
  "chat.runError.gitBashMissingMessage": "在 Windows 上執行此智慧體需要 Git Bash，但找不到。請安裝 Git for Windows 後重試。",
  "chat.runError.cpuUnsupportedMessage": "此智慧體的 runtime 需要這部裝置的處理器不支援的指令集（AVX2），因此無法啟動。請將 Open Design 更新到最新版本；新版附帶相容的 runtime。",
  "common.cancel": "取消",
  ...
  "modelCapability.standard": "標準",
  "modelCapability.advanced": "進階",
  "modelCapability.bestQuality": "最佳品質",
  "modelCapability.standardDescription": "為一般任務提供穩定的輸出品質。",
  "modelCapability.advancedDescription": "為要求更高的任務提供更強的輸出品質。",
  "modelCapability.bestQualityDescription": "為要求最高的工作提供最佳輸出品質。",
