...
i18n:
  zh:
    title: "Open Design 0.15.0：更\u2060省\u2060成\u2060本，更\u2060快\u2060交\u2060付"
    summary: "标签 open-design-v0.15.0 —— 四天内 34 位贡献者提交了 118 个 PR。代号「更\u2060省\u2060成\u2060本，更\u2060快\u2060交\u2060付（Cost\u00a0Less. Ship\u00a0Faster.）」。一个更精简的 Design\u00a0System\u00a0Prompt 在代表性运行中把首个 token 的等待时间缩短了 49.5%、端到端时长缩短了 21.2%、平均输入 token 减少了 25.1%。本次发布的其余部分让整条创作循环更顺滑：像工作区一样的演示文稿、从 URL 克隆网站、把对话变成动态效果，以及终于会告诉你下一步该怎么办的失败提示。"
    category: '产品'
    bodyHtml: |
      ...
      <figure>
        <img src="/blog/open-design-0-15-0-cost-less-ship-faster-speed.webp" alt="一份冗长的提示文档被压缩为精简版本，旁边的计时器与 token 计数同步下降；更快的结果在暖色编辑插画中呈现为宁静的鼠尾草绿色界面" />
      ...
      <figure>
        <img src="/blog/open-design-0-15-0-cost-less-ship-faster-clone.webp" alt="浏览器地址栏中的 URL 转化为包含 NOTES.md 和页面路由的结构化项目文件夹；新项目在暖色编辑插画中呈现为宁静的鼠尾草绿色界面" />
