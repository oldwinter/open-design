...
export const STORY_META: Record<string, StoryMeta> = {
  ...
  "zh": { title: "“I go to Open Design first” — Stuart Gardoll", description: "Stuart Gardoll 是 AI 工程师兼顾问，也是 Connect I/O 创始人；他使用 Open Design，基于自己选择的模型交付应用 UI、动态图形和原型。" },
...
export const STORY_CARD: Record<string, StoryCard> = {
  ...
  "zh": { title: "“I go to Open Design first”", blurb: "身为 AI 工程师和 Connect I/O 创始人，他用 Open Design 构建应用和动态图形；无论选择哪个模型，Open Design 都是他最先打开的创作画布。" },
