...
export const STORY_META: Record<string, StoryMeta> = {
  ...
  "zh": { title: "“My hands stay on the craft” — Seungki Kim", description: "Seungki Kim 曾在 KAIST 学习工业设计，并创立 3D 打印工艺工作室 FABOR。他借助 Open Design 同步打造品牌、网站和社交媒体内容，也能继续专注手中的创作。" },
...
export const STORY_CARD: Record<string, StoryCard> = {
  ...
  "zh": { title: "“My hands stay on the craft”", blurb: "拥有 KAIST 工业设计背景的 FABOR 创始人，借助 Open Design 同步打造品牌网站和社交媒体图文轮播，同时继续专注 3D 打印工艺。" },
