...
- Weight 300 作为 signature headline weight -- 轻盈、自信、反常规
- Display sizes 使用 negative letter-spacing（56px 时 -1.4px，向下逐步放松）
- 使用 `rgba(50,50,93,0.25)` 的 blue-tinted multi-layer shadows -- 带有品牌色感的 elevation
- Headings 使用 deep navy（`#061b31`）而不是黑色 -- warm、premium、financial-grade
