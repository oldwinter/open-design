...
- Design intent：让输出可识别为 premium festival / creator product；backgrounds 使用 radial gradients 来模拟 eclipse 的圆形特征。
- Primary：`#fff6df` — Amber / white-gold，solar corona 和 "diamond ring" 闪光。用于 critical CTAs 和 high-importance highlights。
