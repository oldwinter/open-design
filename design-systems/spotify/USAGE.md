...
- 近黑色沉浸式 dark theme（`#121212`–`#1f1f1f`）— UI 退到内容之后
- Spotify Green（`#1ed760`）作为唯一 brand accent — 从不装饰化，始终功能化
- SpotifyMixUI/CircularSp font family，支持 global script
- Pill buttons（500px–9999px）和 circular controls（50%）— 圆润、为触控优化
