...
- Soft pastel gradients（pink、blue、lavender）置于 pure white canvas 之上
- Dark/research sections 使用 deep midnight blue（`#010120`）— 不是 gray-black
- 自定义 "The Future" font 全程搭配强烈的 negative letter-spacing
- Uppercase technical labels 使用 PP Neue Montreal Mono
