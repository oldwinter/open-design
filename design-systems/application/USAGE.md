...
- 视觉风格： modern, clean, high-contrast, glass-like panels, soft shadows, rounded components
- 色彩取向： primary (purple), neutral, success, warning, danger
- Design intent：保持 output 可识别为这一 style family，同时保留 usability 和 readability。
- Primary：`#9333EA` — 来自 style foundations 的 token。
