...
- 视觉风格： clean, friendly, content-first
- 色彩取向： bright surfaces with purple accent
- Design intent：保持 output 可识别为这一 style family，同时保留 usability 和 readability。
- 不要将 Tertiary `#9B9CA3` 用于 body text；仅用于 timestamps 和 metadata
