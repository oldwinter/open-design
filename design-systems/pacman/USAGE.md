...
- 视觉风格： high-contrast, playful, dotted borders
- 色彩取向： primary, secondary, success, warning, danger, info, surface/subtle layers
- Design intent：保持 output 可识别为这一 style family，同时保留 usability 和 readability。
- Primary：`#2A3FE5` — 来自 style foundations 的 token。
