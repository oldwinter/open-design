# Trading Terminal Design System 使用指南
...
- Color stance：dark surfaces 搭配 high-contrast data colors
- Design intent：在保持 usability 和 readability 的同时，让输出仍可识别为这个 style family
- 不要只靠颜色表达 buy/sell — 始终搭配 directional icon 或 label
