...
- Deep purple gradient hero（`#1b1938`）与以白色为主的 content body 形成对比
- Super Sans VF variable font 使用非标准 weight stops（460、540、600、700）— 介于常规字重类别之间
- Ultra-tight display line-height（0.96）营造压缩、有力的 headlines
- Buttons 使用 Warm Cream（`#e9e5dd`）而非明亮/高饱和 CTAs — 克制的 luxury
