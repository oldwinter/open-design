...
const residualAllowedExactPaths = new Set([
  ...
  // Browser vendor bundles generated by `vendor-enhancers.ts` for Astro
  // development and builds; these are upstream assets, not project-owned JS.
  "apps/landing-page/public/enhancers/cobe.js",
  "apps/landing-page/public/enhancers/matter.min.js",
