...
description: "高端暗色电影感编程教育平台 Hero：全屏 HLS 背景视频、液态玻璃卡片、绿色强调的大写排版、中央光晕、桌面网格线，以及可用的移动端汉堡菜单。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
> 中文说明：高端暗色电影感编程教育平台 Hero：全屏 HLS 背景视频、液态玻璃卡片、绿色强调的大写排版、中央光晕、桌面网格线，以及可用的移动端汉堡菜单。
>
