...
description: "高端 GSAP 电影感 B2B 落地页：滚动驱动的全屏视频切换 Hero（clip-path 椭圆转场）、SplitText 逐字标题、瀑布流产品画廊、滚动揭示文案、合作伙伴跑马灯、Lottie 特性卡片与多办公室页脚。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
# 电影感落地页 — Bakery Facilities

> 中文说明：高端 GSAP 电影感 B2B 落地页：滚动驱动的全屏视频切换 Hero（clip-path 椭圆转场）、SplitText 逐字标题、瀑布流产品画廊、滚动揭示文案、合作伙伴跑马灯、Lottie 特性卡片与多办公室页脚。
>
