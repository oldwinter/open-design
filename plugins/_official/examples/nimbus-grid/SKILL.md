---
name: nimbus-grid
description: "暗金色调的安全云存储产品单页营销站：着色器英雄区配实时控制台与打字机动效、滚动驱动的吸顶平台手风琴、随滚动形变的价格柱状图、安全卡片、3D 倾斜控制台展示，以及点击爆裂的运营立方体。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
# Nimbus Grid — 安全云存储营销页

> 中文说明：暗金色调的安全云存储产品单页营销站：着色器英雄区配实时控制台与打字机动效、滚动驱动的吸顶平台手风琴、随滚动形变的价格柱状图、安全卡片、3D 倾斜控制台展示，以及点击爆裂的运营立方体。
>
