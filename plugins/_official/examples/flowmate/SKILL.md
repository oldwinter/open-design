---
name: flowmate
description: "可直接上线的 AI 自动化 SaaS 落地页：固定 240px 侧栏、毛玻璃吸顶导航、PPMondwest 衬线 Hero、产品视频上的液态玻璃打字机卡片、6 张功能卡网格，以及自动轮播的 5 卡轮播。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
# FlowMate — AI 工作流自动化落地页

> 中文说明：可直接上线的 AI 自动化 SaaS 落地页：固定 240px 侧栏、毛玻璃吸顶导航、PPMondwest 衬线 Hero、产品视频上的液态玻璃打字机卡片、6 张功能卡网格，以及自动轮播的 5 卡轮播。
>
