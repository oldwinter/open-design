...
description: "暗调电影感创意工作室落地页，暖奶油色调：全屏 Hero 视频配巨型逐词上滑标题、衬线斜体 About 文案配滚动逐字显影，以及四列 Features 网格（一个视频卡 + 三个清单卡）。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
> 中文说明：暗调电影感创意工作室落地页，暖奶油色调：全屏 Hero 视频配巨型逐词上滑标题、衬线斜体 About 文案配滚动逐字显影，以及四列 Features 网格（一个视频卡 + 三个清单卡）。
>
