...
# 现代设计公司 — Axion Studio 落地页

> 中文说明：高端设计公司落地页：全屏 shader 英雄区配胶囊导航栏与伦敦实时时钟、文字滚动悬停按钮、策略导向的关于区，以及带自动播放视频的双卡精选案例栅格。
>
