---
name: stellar-launch
description: "高端创投大奖落地页：内嵌白色圆角卡片外壳、全屏视频 Hero 配斜切 clip-path CTA、围绕方形视频的三栏几何提名卡区，以及使用 plus-darker 图像卡和渐变文字数字的创始人统计网格。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
# Stellar Launch — Launchex 创投大奖落地页

> 中文说明：高端创投大奖落地页：内嵌白色圆角卡片外壳、全屏视频 Hero 配斜切 clip-path CTA、围绕方形视频的三栏几何提名卡区，以及使用 plus-darker 图像卡和渐变文字数字的创始人统计网格。
>
