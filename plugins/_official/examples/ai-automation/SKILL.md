---
name: ai-automation
description: "高端深色视频背景的 AI 机构落地页（COGNITRA）：全屏固定背景视频、透明导航栏、上半部灰色面板的 Hero、逐词淡入的 Statement，以及带循环视频缩略图的三卡片 Services 网格。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
# AI Automation — COGNITRA 智能体落地页

> 中文说明：高端深色视频背景的 AI 机构落地页（COGNITRA）：全屏固定背景视频、透明导航栏、上半部灰色面板的 Hero、逐词淡入的 Statement，以及带循环视频缩略图的三卡片 Services 网格。
>
