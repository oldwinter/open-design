---
name: art-landing
description: "两段式滚动落地页：全屏视频主视觉配 Italiana 大标题，下接纯红 #FF0000 区块，含视差云层过渡、Marck Script 手写签名与底部循环视频。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
> 中文说明：两段式滚动落地页：全屏视频主视觉配 Italiana 大标题，下接纯红 #FF0000 区块，含视差云层过渡、Marck Script 手写签名与底部循环视频。
>
