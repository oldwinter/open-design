...
description: "纯黑单色的 newsletter/内容平台落地页：全屏视频 Hero、Instrument Serif 斜体强调词、液态玻璃控件、随滚动逐词点亮的 mission 段落，以及 HLS 视频 CTA。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
# Mindloop Landing — 纯黑单色内容平台落地页

> 中文说明：纯黑单色的 newsletter/内容平台落地页：全屏视频 Hero、Instrument Serif 斜体强调词、液态玻璃控件、随滚动逐词点亮的 mission 段落，以及 HLS 视频 CTA。
>
