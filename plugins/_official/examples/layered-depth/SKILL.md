---
name: layered-depth
description: "电影感层叠视差建筑事务所落地页：全屏背景视频、视差雕塑石板后的巨型品牌字标、飞鸟视频状态机、磨砂玻璃导航胶囊与信息面板，以及带居中编排标题的第二屏全屏视频区。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
# 层叠深度 — Qelora 建筑事务所落地页

> 中文说明：电影感层叠视差建筑事务所落地页：全屏背景视频、视差雕塑石板后的巨型品牌字标、飞鸟视频状态机、磨砂玻璃导航胶囊与信息面板，以及带居中编排标题的第二屏全屏视频区。
>
