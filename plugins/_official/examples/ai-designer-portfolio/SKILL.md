...
description: "高端纯白创意工作室落地页：衬线点缀的 Hero、无限滚动 GIF 跑马灯、视差证言、双卡定价、自动轮播证言、纵向项目展示、鼠标拖尾合作 CTA，以及固定悬浮底栏。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
# AI 设计师作品集 — Viktor Oddy 创意工作室

> 中文说明：高端纯白创意工作室落地页：衬线点缀的 Hero、无限滚动 GIF 跑马灯、视差证言、双卡定价、自动轮播证言、纵向项目展示、鼠标拖尾合作 CTA，以及固定悬浮底栏。
>
