...
description: "高端暗色单页作品集落地页：电影感 HLS 视频首屏、Instrument Serif 斜体标题、000→100 加载计数器、错位 bento 作品网格、滚动钉住的视差探索画廊，以及带 #89AACC→#4E85BF 渐变强调色的跑马灯联系页脚。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
# Portfolio Cosmic — 暗色个人作品集落地页

> 中文说明：高端暗色单页作品集落地页：电影感 HLS 视频首屏、Instrument Serif 斜体标题、000→100 加载计数器、错位 bento 作品网格、滚动钉住的视差探索画廊，以及带 #89AACC→#4E85BF 渐变强调色的跑马灯联系页脚。
>
