...
description: "暗黑高奢风 AI 网页设计代理单页落地页：电影级视频背景、Instrument Serif 斜体标题、液态玻璃卡片与 CTA、BlurText 逐词浮现动画，分段叙事。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
> 中文说明：暗黑高奢风 AI 网页设计代理单页落地页：电影级视频背景、Instrument Serif 斜体标题、液态玻璃卡片与 CTA、BlurText 逐词浮现动画，分段叙事。
>
