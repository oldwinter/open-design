---
name: shamoni
description: "沉浸式滚动驱动落地页：全屏背景视频、随滚动展开的椭圆裁切揭示、数学精确的环绕图片画廊在视口中放大并横扫，配合随滚动淡入淡出的衬线遮罩文字。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
> 中文说明：沉浸式滚动驱动落地页：全屏背景视频、随滚动展开的椭圆裁切揭示、数学精确的环绕图片画廊在视口中放大并横扫，配合随滚动淡入淡出的衬线遮罩文字。
>
