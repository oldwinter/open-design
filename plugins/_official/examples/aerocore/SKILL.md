---
name: aerocore
description: "高端电影感航天动力营销站：蓝转暖白渐变 Hero（视差大字 + 发动机静帧）、由缩略图放大为全屏粘性视频的展示、固定标签页 showcase、含循环视频卡与工具跑马灯的 bento 能力网格、深色动画数据图、横向视频故事轨与星点页脚。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
# AeroCore — 航天发动机电影感着陆页

> 中文说明：高端电影感航天动力营销站：蓝转暖白渐变 Hero（视差大字 + 发动机静帧）、由缩略图放大为全屏粘性视频的展示、固定标签页 showcase、含循环视频卡与工具跑马灯的 bento 能力网格、深色动画数据图、横向视频故事轨与星点页脚。
>
