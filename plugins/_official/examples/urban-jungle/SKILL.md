---
name: urban-jungle
description: "电影感滚动英雄页：随滚动逐帧擦除的全屏视频、超大展示字体标题随滚动飘散、从底部滑入的毛玻璃 About 面板、GSAP 液态填充胶囊导航与文字 logo 跑马灯。"
version: 0.1.0
od:
  mode: prototype
  surface: web
...
# Urban Jungle — 滚动视频英雄页

> 中文说明：电影感滚动英雄页：随滚动逐帧擦除的全屏视频、超大展示字体标题随滚动飘散、从底部滑入的毛玻璃 About 面板、GSAP 液态填充胶囊导航与文字 logo 跑马灯。
>
