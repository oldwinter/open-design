...
<p align="center"><a href="https://github.com/nexu-io/open-design/blob/main/MAINTAINERS.md">English</a> · <a href="docs/i18n/MAINTAINERS.pt-BR.md">Português (Brasil)</a> · <a href="docs/i18n/MAINTAINERS.de.md">Deutsch</a> · <a href="docs/i18n/MAINTAINERS.fr.md">Français</a> · <b>简体中文</b> · <a href="docs/i18n/MAINTAINERS.ja-JP.md">日本語</a> · <a href="docs/i18n/MAINTAINERS.ko.md">한국어</a> · <a href="docs/i18n/MAINTAINERS.th.md">ภาษาไทย</a></p>
...
| **External Maintainer**（外部 Maintainer） | 按本文档规则晋升的社区贡献者。可 review、approve、关闭/重开 issue、自分配 issue。**不能点 Merge 按钮**，该权限保留在 Core Team。 |
...
**没有提名 PR、没有公开投票、没有固定任期**。这是有意做的选择，和 K8s/Apache 的 approver 投票模型相反：项目早期 Core Team 共识更快，也能产生同等质量的结果。**当 External Maintainer 数量超过 5 人时，本节将被重新审视**。
...
如果 Core Team 观察到 bad-case 行为（草率 approve、恶意 close issue、泄漏未公开 roadmap 等），权限会按“强制退出”路径回收。
...
2. 14 天内仍无实质响应，则转入 Emeritus，回收权限。
3. 在 GitHub Discussions 公开发简短善意说明：“感谢你的贡献，你已转入 Emeritus，欢迎随时回归。”
...
Emeritus 的意义是承认生活会发生事：休假、换工作、生孩子。双方都不需要任何 drama 或社交压力。
